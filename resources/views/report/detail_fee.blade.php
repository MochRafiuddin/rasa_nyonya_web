...
<div class="main-panel">
    <div class="content-wrapper">
        <div class="card">
            <div class="card-body">
                <h4>Courier Fee Detail - {{$courier->nama}} - {{$courier->nama_wilayah}}</h4><br>
...
<script>
    $(document).ready(function () {
        ...
        function set_total() {
            ...
            $.ajax({
                url: "{{url('courier-fee/get-total-fee')}}",
                type: "get",
                data:  {
                ...
                success: function(res){
                    $('.total-fee').html("Total Fee : "+res.deliver);
                }
            });
        }
        function load_tabel() {
            ...
            $('.table').DataTable({
                ...
                "scrollX": true,
                ajax: {
                    url: '{{ url("courier-fee/data-detail") }}',
                    type: 'get',
